...
<head>
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm"
    crossorigin="anonymous">
  <link href="style_mr.css" rel="stylesheet">
...
<body>
  ...
  <h1 class="header-w3ls">Your Feedback Matters </h1>

  <div class="art-bothside">
    <form method="post" action="insert_rating.php">
      <div class="dive" ALIGN="center">
        <p>How would you rate your satisfaction with SeniorCare services?</p>
      ...
      <div class="set-reset" ALIGN="center">
        <input type="submit" name="submitR" id="btnSubmit" value="Submit " onclick="myMsg()">
      </div>
